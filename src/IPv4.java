...
//	}
    ...
    public void SetProperties(Packet packet) {
        ...
        properties.put(propertyLabels.get(0), 4);
        properties.put(propertyLabels.get(1), (int) ip.priority);
        properties.put(propertyLabels.get(2), ip.t_flag);
        properties.put(propertyLabels.get(3), ip.r_flag);
        properties.put(propertyLabels.get(4), (int) ip.length);
        properties.put(propertyLabels.get(5), ip.ident);
        properties.put(propertyLabels.get(6), ip.dont_frag);
        properties.put(propertyLabels.get(7), ip.more_frag);
        properties.put(propertyLabels.get(8), (int) ip.offset);
        properties.put(propertyLabels.get(9), (int) ip.hop_limit);
        properties.put(propertyLabels.get(10), (int) ip.protocol);
